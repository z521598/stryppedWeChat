...
public class PackageScanUtils {
    ...
    public static Set<String> findPackageAnnotationClass(String scanPackages,
        ...
        for (Class<? extends Annotation> annotation : annotations) {
            Set<String> oneClassSet = findPackageAnnotationClass(scanPackages, annotation);
            if (CollUtils.isEmpty(oneClassSet)) {
                continue;
            }
            CollUtils.addAll(classes, oneClassSet.iterator());
        }
        return classes;
    }
