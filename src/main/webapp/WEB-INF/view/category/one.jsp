...
<head>
    ...
    <link rel="stylesheet" href="/resources/assets/css/wx-custom.css">
</head>
<body>
<div class="container">
<!-- 自定义菜单 -->
        ...
        <div class="inner-left">
            <div class="custom-menu-view-con">
                <div class="custom-menu-view">
                    <div class="custom-menu-view__title">请完成自定义菜单</div>
                    ...
                    <div id="col_1" class="col-xs-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="msg-img"><img src="/resources/assets/images/20170831595cf16beb634972a65adb6b14abca9b.jpg" alt=""></div>
                    ...
                    <div id="col_2" class="col-xs-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="msg-img"><img src="/resources/assets/images/1.png" alt=""></div>
                                <p class="msg-text">微信缴费使用指南</p>
                            </div>
                            <div class="mask-bg"><div class="mask-icon"><i class="icon-ok"></i></div></div>
                        </div>
